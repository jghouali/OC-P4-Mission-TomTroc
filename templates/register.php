...
<main class="flex-1">
    ...
    <section class="bg-[#FAF9F7]">
        <div class="flex flex-col md:flex-row md:gap-[30px] md:justify-between">
            <div class="pt-[78px] self-center w-full sm:w-[322px] max-w-[335px] xl:max-w-[485px] md:pl-[20px] xl:pl-[150px] 2xl:pl-[1000px]">
                ...
                <form action="/register" method="post" class="flex flex-col w-full">
                    <label for="username" class="font-inter font-normal tracking-normal text-[14px] text-grey pb-[10px]">Pseudo</label>
                    ...
                    <label for="email" class="font-inter font-normal tracking-normal text-[14px] text-grey pb-[10px]">Adresse email</label>
                    <input type="text" name="email" id="login-email" class="sm:w-[322px] h-[50px] mb-[32px] bg-white rounded-[6px] border-[1px] border-[#F0F0F0]">
                    <label for="password" class="font-inter font-normal tracking-normal text-[14px] text-grey pb-[10px]">Mot de passe</label>
                    ...
                    <p class="font-inter font-normal tracking-normal text-[14px] text-dark mt-[40px]">Déjà inscrit ? <a href="/login" class="underline">Connectez-vous</a></p>
                </form>
            </div>
            <div class="pr-0"><img src="/images/books.png" alt="" class="h-full"></div>
        </div>
    </section>
</main>