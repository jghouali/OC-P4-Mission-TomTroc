        ...
        <div class="flex flex-col md:flex-row md:gap-[30px] md:justify-between">
            <div class="pt-[78px] md:pt-[130px] w-full self-center sm:self-start sm:w-[322px] max-w-[335px] xl:max-w-[485px] md:pl-[20px] xl:pl-[150px] 2xl:pl-[400px]">
                ...
                <form action="/register" method="post" class="flex flex-col w-full">
                    <label for="username" class="sm:w-[322px] font-inter font-normal tracking-normal text-[14px] text-grey pb-[10px]">Pseudo</label>
                    ...
                    <label for="email" class="sm:w-[322px] font-inter font-normal tracking-normal text-[14px] text-grey pb-[10px]">Adresse email</label>
                    <input type="text" name="email" id="login-email" class="sm:w-[322px] h-[50px] mb-[32px] bg-white rounded-[6px] border-[1px] border-[#F0F0F0]">
                    <label for="password" class="sm:w-[322px] font-inter font-normal tracking-normal text-[14px] text-grey pb-[10px]">Mot de passe</label>
