...
?>
<main class="flex-1">
    <section class="bg-[#F5F3EF] pb-[48px] sm:pb-[101px] sm:pt-[80px]">
        <div class="flex flex-col-reverse sm:flex-row justify-center gap-[32px] sm:gap-[108px]">
            <div class="max-w-[335px] sm:w-[329px] ml-[20px] mr-[20px] self-center">
                <h1 class="font-playfair font-normal tracking-normal leading-[1.3] text-[30px] sm:text-[36px] text-black pb-[16px]">Rejoignez nos lecteurs passionés</h1>
                <p class="pl-[1px] font-inter font-light leading-[1.2] tracking-normal text-[16px] text-black">Donnez une nouvelle vie à vos livres en les
                ...
                <a href="/available-books"><button class="font-inter font-semibold leading-none tracking-normal text-[16px] text-center text-white w-full sm:w-[152px] h-[63px] bg-primary duration-300 ease-in-out hover:bg-primary-hover rounded-[10px] mt-[40px]">Découvrir</button></a>
            </div>
            <div>
                <img class="w-full sm:w-[404px]" src="/images/hamza-nouasria.jpg" alt="">
    ...
    <section class="bg-[#FAF9F7]">
        <div class="pt-[48px] sm:pt-[80px] ml-[20px] mr-[20px] self-center">

            <div class="flex flex-col items-center pb-[80px] sm:pb-[64px]">
                <h2 class="pb-[34px] sm:pb-[80px] pl-[35px] pr-[35px] font-playfair font-normal leading-none tracking-normal text-center text-[28px] sm:text-[32px] text-dark">Les derniers livres ajoutés</h2>
                ...
                <a href="/available-books" class="hidden sm:flex"><button class="font-inter font-semibold leading-none tracking-normal text-[16px] text-center text-white w-[218px] h-[63px] sm:mt-[48px] pt-[22px] pb-[22px] pl-[38px] pr-[38px] bg-[#00AC66] rounded-[10px] duration-300 ease-in-out hover:bg-[#006D41]">Voir tous les livres</button></a>
            </div>

        </div>
    </section>
    <section class="bg-[#F5F3EF] pb-[48px] sm:pb-[80px]">
        <div class="flex flex-col justify-center items-center ml-[20px] mr-[20px]">
            ...
            <div class="sm:flex sm:flex-col items-center">
                <div class="flex flex-col flex-wrap sm:flex-row justify-center items-center gap-[16px] sm:gap-[38px]">
                    <div class="card2-text bg-white pb-[52px] sm:pb-[44px] pt-[53px] sm:pt-[44px] pl-[28px] sm:pl-[17px] pr-[26px] sm:pr-[18px] rounded-[10px] w-full sm:w-[215px] h-[139px]">
                        <p class="w-[180] h-full align-middle sm:h-[51]">Inscrivez-vous gratuitement sur <br>notre plateforme.</p>
                    </div>
                    <div class="card2-text bg-white pb-[52px] sm:pb-[44px] pt-[53px] sm:pt-[44px] pl-[28px] sm:pl-[17px] pr-[26px] sm:pr-[18px] rounded-[10px] w-full sm:w-[215px] h-[139px]">
                        <p class="w-[180] sm:h-[51]">Ajoutez les livres que vous souhaitez échanger à <br>votre profil.</p>
                    </div>
                    <div class="card2-text bg-white pb-[52px] sm:pb-[44px] pt-[53px] sm:pt-[44px] pl-[28px] sm:pl-[17px] pr-[26px] sm:pr-[18px] rounded-[10px] w-full sm:w-[215px] h-[139px]">
                        <p class="w-[180] h-[51]">Parcourez les livres disponibles chez d'autres membres.</p>
                    </div>
                    <div class="card2-text bg-white pb-[52px] sm:pb-[44px] pt-[53px] sm:pt-[44px] pl-[28px] sm:pl-[17px] pr-[26px] sm:pr-[18px] rounded-[10px] w-full sm:w-[215px] h-[139px]">
                        <p class="w-[180] h-[51]">Proposez un échange et discutez avec d'autres passionnés de lecture.</p>
                    </div>
                </div>
                <div>
                    <a href="/available-books" class="w-full">
                        <button class="w-full sm:w-[218px] h-[63px] mt-[32px] sm:mt-[48px] pt-[22px] pb-[22px] font-inter font-semibold leading-none tracking-normal text-[16px] text-center text-primary duration-300 ease-in-out hover:text-white bg-[#F5F3EF] border-[#00AC66] border-[1px] rounded-[10px] duration-300 ease-in-out hover:bg-[#006D41]">Voir tous les livres</button>
                    </a>
                </div>
            </div>
        </div>
    </section>
    <section class="bg-[#FAF9F7] pb-[196px] sm:pb-[162px]">
        ...
        <div class="ml-[20px] mr-[20px] flex flex-col justify-center items-center">
            <div>
                ...
                <div class="relative">
                    <img src="/images/coeur.png" alt="" class="absolute bottom-[-160px] sm:bottom-[-75px] left-[106px] sm:left-[342px]">
                </div>
            </div>
